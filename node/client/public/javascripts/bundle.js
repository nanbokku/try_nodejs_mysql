...
},{"./view/todo_list":4,"jquery":5}],2:[function(require,module,exports){
function Event(name) {
  this.name = name;
  this.callbacks = [];
}
...
},{"../utils/reactor":2,"jquery":5,"underscore":6}],4:[function(require,module,exports){
const $ = require('jquery');
const _ = require('underscore');
...
},{"../utils/reactor":2,"./todo":3,"jquery":5,"underscore":6}],5:[function(require,module,exports){
/*!
